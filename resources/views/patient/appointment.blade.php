    ...
    <div class="container">
        ...
        <div class="dash-body">
                ...
                <tr>
                    ...
                    <td>
                        <p style="font-size: 23px;padding-left:12px;font-weight: 600;">Bookings</p>
...
<tbody>
    @foreach($appointments as $appointment)
        <tr>
            ...
            <td>
            <form action="{{ route('destroy-patientbooking', ['email' => $patient->email, 'appointment' => $appointment->id]) }}" method="post" style="display: inline;" onsubmit="return confirm('Are you sure you want to delete this appointment?');">
    @csrf
    @method('DELETE')
